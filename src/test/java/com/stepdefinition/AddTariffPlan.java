...
public class AddTariffPlan {
	...
	public void the_user_fill_all_details_in_list(DataTable dataTable) {
		 ...
		 driver.findElement(By.xpath("//input[@name='rental']")).sendKeys(CustomerdetailsList.get(0));
			driver.findElement(By.xpath("//input[@name='local_minutes']")).sendKeys(CustomerdetailsList.get(1));
			driver.findElement(By.xpath("//input[@name='inter_minutes']")).sendKeys(CustomerdetailsList.get(2));
			driver.findElement(By.xpath("//input[@name='sms_pack']")).sendKeys(CustomerdetailsList.get(3));
			driver.findElement(By.xpath("//input[@name='minutes_charges']")).sendKeys(CustomerdetailsList.get(4));
			driver.findElement(By.xpath("//input[@name='inter_charges']")).sendKeys(CustomerdetailsList.get(5));
			driver.findElement(By.xpath("//input[@name='sms_charges']")).sendKeys(CustomerdetailsList.get(6));
	}
